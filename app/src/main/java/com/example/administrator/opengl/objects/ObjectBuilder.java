...
public class ObjectBuilder {
    ...
    private void appendCircle(Geometry.Circle circle, int numPoints) {// Center point of fan
        ...
        vertexData[offset++] = circle.center.z;// Fan around center point. <= is used because we want to generate// the point at the starting angle twice to complete the fan.
   ...
   public static class GeneratedData {
    ...
    static GeneratedData createMallet(Geometry.Point center, float radius, float height, int numPoints) {
        ...
        ObjectBuilder builder = new ObjectBuilder(size);// First, generate the mallet base.
